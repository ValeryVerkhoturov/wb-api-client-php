...
class TableItemItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'add_to_cart' => '\ValeryVerkhoturov\WbApiClient\Analytics\Model\TableGroupItemMetricsAddToCart',
        'open_to_cart' => '\ValeryVerkhoturov\WbApiClient\Analytics\Model\TableGroupItemMetricsOpenToCart',
        'orders' => '\ValeryVerkhoturov\WbApiClient\Analytics\Model\TableGroupItemMetricsOrders',
        'cart_to_order' => '\ValeryVerkhoturov\WbApiClient\Analytics\Model\TableGroupItemMetricsCartToOrder',
        'visibility' => '\ValeryVerkhoturov\WbApiClient\Analytics\Model\TableGroupItemMetricsVisibility'
    ];
    ...
    */
     ...
     *
     * @param bool|null $is_substituted_sku Искали ли товар по подменному артикулу. Поле будет в ответе при наличии в запросе `includeSubstitutedSKUs` и/или `includeSearchTexts`
     *
     * @return self
     */
