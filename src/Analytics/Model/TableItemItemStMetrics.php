...
class TableItemItemStMetrics implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'orders_sum' => 'int',
        'avg_orders' => 'float',
        'avg_orders_by_month' => '\ValeryVerkhoturov\WbApiClient\Analytics\Model\FloatGraphByPeriodItem[]',
        'buyout_count' => 'int',
        'buyout_sum' => 'int',
        'buyout_percent' => 'int',
        'stock_count' => 'int',
        'stock_sum' => 'int',
        'sale_rate' => '\ValeryVerkhoturov\WbApiClient\Analytics\Model\TableCommonMetricsSaleRate',
        'avg_stock_turnover' => '\ValeryVerkhoturov\WbApiClient\Analytics\Model\TableCommonMetricsAvgStockTurnover',
        'to_client_count' => 'int',
        'from_client_count' => 'int',
        'office_missing_time' => '\ValeryVerkhoturov\WbApiClient\Analytics\Model\TableCommonMetricsOfficeMissingTime',
        'lost_orders_count' => 'float',
        'lost_orders_sum' => 'float',
        'lost_buyouts_count' => 'float',
        'lost_buyouts_sum' => 'float',
        'current_price' => '\ValeryVerkhoturov\WbApiClient\Analytics\Model\TableItemItemStMetricsAllOfCurrentPrice',
        'availability' => 'string'
    ];
