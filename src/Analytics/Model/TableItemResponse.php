...
class TableItemResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'items' => '\ValeryVerkhoturov\WbApiClient\Analytics\Model\TableItemItemSt[]',
        'currency' => 'string'
    ];
    ...
    */
     ...
     * Sets items
     *
     * @param \ValeryVerkhoturov\WbApiClient\Analytics\Model\TableItemItemSt[] $items Множество данных по товарам
     *
     * @return self
     */
