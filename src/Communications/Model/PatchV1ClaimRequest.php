...
class PatchV1ClaimRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets action
     *
     * @param string $action Действие с заявкой. Используйте одно из значений массива `actions` — ответа [метода получения заявок](./customer-communication#tag/buyersReturns/operation/getV1Claims)
     *
     * @return self
     */
     ...
     * Sets comment
     *
     * @param string|null $comment Комментарий. Применимо только при `\"action\":\"rejectcustom\"` или `\"action\":\"approvecc1\"`. При `\"action\":\"rejectcustom\"` параметр обязателен
     *
     * @return self
     */
