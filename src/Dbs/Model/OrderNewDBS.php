...
class OrderNewDBS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'comment' => 'string',
        'options' => '\ValeryVerkhoturov\WbApiClient\Dbs\Model\OrderNewDBSOptions',
        'address' => '\ValeryVerkhoturov\WbApiClient\Dbs\Model\OrderNewDBSAddress',
        'order_uid' => 'string',
        'group_id' => 'string',
        'article' => 'string',
        'color_code' => 'string',
    ...
    */
     ...
     * Gets options
     *
     * @return \ValeryVerkhoturov\WbApiClient\Dbs\Model\OrderNewDBSOptions|null
     */
     ...
     * Sets options
     *
     * @param \ValeryVerkhoturov\WbApiClient\Dbs\Model\OrderNewDBSOptions|null $options options
     *
     * @return self
     */
     ...
     * Gets address
     *
     * @return \ValeryVerkhoturov\WbApiClient\Dbs\Model\OrderNewDBSAddress|null
     */
     ...
     * Sets address
     *
     * @param \ValeryVerkhoturov\WbApiClient\Dbs\Model\OrderNewDBSAddress|null $address address
     *
     * @return self
     */
     ...
     * Sets group_id
     *
     * @param string|null $group_id ID группы сборочных заданий.  Объединяет сборочные задания, поступившие на один склад (`warehouseId`) в рамках одной транзакции покупателя (`orderUid`)
     *
     * @return self
     */
     ...
     * Sets rid
     *
     * @param mixed|null $rid Уникальный ID заказа. Примечание: `rid` — это `srid` в ответах методов: - [Заявки покупателей на возврат](./customer-communication#tag/buyersReturns/operation/getV1Claims) - [Лента заказов](./analytics#tag/orderFeed/operation/postV1OrderFeed) - [Заказы](./reports#tag/mainReports/operation/getV1SupplierOrders) - [Продажи](./reports#tag/mainReports/operation/getV1SupplierSales) - [Отчёт о возвратах и перемещении товаров](./reports#tag/returnsAndItemMovementReport) - [Детализации к отчётам реализации по ID отчётов](./documents-and-accounting#tag/financialReports/operation/postV1SalesReportsDetailedReportId) - [Детализации к отчётам реализации за период](./documents-and-accounting#tag/financialReports/operation/postV1SalesReportsDetailed) - [Детализации к отчётам об издержках на приём платежей по ID отчётов](./documents-and-accounting#tag/financialReports/operation/postV1AcquiringDetailedReportId) - [Детализации к отчётам об издержках на приём платежей за период](./documents-and-accounting#tag/financialReports/operation/postV1AcquiringDetailed)
     *
     * @return self
     */
