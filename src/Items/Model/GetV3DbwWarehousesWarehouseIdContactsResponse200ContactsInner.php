...
/**
 * GetV3DbwWarehousesWarehouseIdContactsResponse200ContactsInner Class Doc Comment
 *
 * @category Class
 * @package  ValeryVerkhoturov\WbApiClient\Items
 * @author   OpenAPI Generator team
 ...
 */
class GetV3DbwWarehousesWarehouseIdContactsResponse200ContactsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetV3DbwWarehousesWarehouseIdContactsResponse200_contacts_inner';
    ...
    */
    ...
    public function setComment($comment)
    {
        ...
        if ((mb_strlen($comment) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling GetV3DbwWarehousesWarehouseIdContactsResponse200ContactsInner., must be smaller than or equal to 1000.');
        }
