...
class PostV2CardsUpdateRequestInnerSizesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets chrt_id
     *
     * @param int|null $chrt_id ID размера для данного артикула WB Обязателен к заполнению для существующих размеров Для добавляемых размеров не указывается
     *
     * @return self
     */
     ...
     * Sets price
     *
     * @param int|null $price Цена товара, ₽ Указывается при добавлении размера
     *
     * @return self
     */
