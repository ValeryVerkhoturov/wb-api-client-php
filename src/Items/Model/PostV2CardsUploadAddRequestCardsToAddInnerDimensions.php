 ...
 *
 * @category Class
 * @description Габариты и вес товара \\*\\*c упаковкой\\*\\*. Укажите в &#x60;сантиметрах&#x60; и &#x60;килограммах&#x60; для любого товара. Если данные не указаны, автоматически сгенерируются нулевые значения длины, ширины, высоты и веса. Синхронизация данных с сервисом может занимать до 30 минут
 * @package  ValeryVerkhoturov\WbApiClient\Items
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
