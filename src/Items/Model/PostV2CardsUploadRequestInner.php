...
class PostV2CardsUploadRequestInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'subject_id' => 'int',
        'variants' => '\ValeryVerkhoturov\WbApiClient\Items\Model\PostV2CardsUploadRequestInnerVariantsInner[]'
    ];
    ...
    */
     ...
     * Gets variants
     *
     * @return \ValeryVerkhoturov\WbApiClient\Items\Model\PostV2CardsUploadRequestInnerVariantsInner[]
     */
     ...
     * Sets variants
     *
     * @param \ValeryVerkhoturov\WbApiClient\Items\Model\PostV2CardsUploadRequestInnerVariantsInner[] $variants [Объединённые](https://dev.wildberries.ru/knowledge-base/articles/019d49a4-1320-71bb-9dac-8ba07e7177ce/rabota-s-tovarami#obuedinenie-i-razuedinenie-kartochek-tovarov) карточки товаров. Чтобы создать отдельную карточку, передайте только один объект
     *
     * @return self
     */
