...
class PostV2CardsUploadRequestInnerVariantsInnerSizesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets skus
     *
     * @param string[]|null $skus Массив баркодов для размера. Если не указать, сгенерируется автоматически. Позволяет связать несколько баркодов с одним размером, например, для разных партий товара
     *
     * @return self
     */
