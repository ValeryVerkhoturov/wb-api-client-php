...
class PostV2UploadTaskSizeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\ValeryVerkhoturov\WbApiClient\Items\Model\SizeGoodReq[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \ValeryVerkhoturov\WbApiClient\Items\Model\SizeGoodReq[]
     */
     ...
     * Sets data
     *
     * @param \ValeryVerkhoturov\WbApiClient\Items\Model\SizeGoodReq[] $data Размеры и цены для них. Максимум 1 000 размеров.  Для товаров с поразмерной установкой цен [карантин](https://seller.wildberries.ru/instructions/ru/ru/material/price-quarantine) не применяется
     *
     * @return self
     */
