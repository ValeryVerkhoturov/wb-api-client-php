...
/**
 * PostV3MediaFileRequest Class Doc Comment
 *
 * @category Class
 * @package  ValeryVerkhoturov\WbApiClient\Items
 * @author   OpenAPI Generator team
 ...
 */
class PostV3MediaFileRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'postV3MediaFile_request';
    ...
    {
        $this->setIfExists('uploadfile', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets uploadfile
     *
     * @param \SplFileObject|null $uploadfile uploadfile
     *
     * @return self
     */
    public function setUploadfile($uploadfile)
    {
        if (is_null($uploadfile)) {
            throw new \InvalidArgumentException('non-nullable uploadfile cannot be null');
        }
