...
class PutV3WarehousesWarehouseIdRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets office_id
     *
     * @param int $office_id ID [склада WB](./item-management#tag/sellerWarehouses/operation/getV3Offices). Нельзя привязывать склад WB, который уже используется. Можно менять не чаще одного раза в сутки
     *
     * @return self
     */
