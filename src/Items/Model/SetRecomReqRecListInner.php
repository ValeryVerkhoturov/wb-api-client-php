...
class SetRecomReqRecListInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'nm_id' => 'int',
        'recommendations' => '\ValeryVerkhoturov\WbApiClient\Items\Model\SetRecomReqRecListInnerRecommendationsInner[]'
    ];
    ...
    */
     ...
     *
     * @return \ValeryVerkhoturov\WbApiClient\Items\Model\SetRecomReqRecListInnerRecommendationsInner[]|null
     */
     ...
     *
     * @param \ValeryVerkhoturov\WbApiClient\Items\Model\SetRecomReqRecListInnerRecommendationsInner[]|null $recommendations Рекомендуемые товары.  Укажите `recomNm` товаров, чтобы добавить их в рекомендации к указанному `nmId`.  При отправке пустого массива `[]` все текущие рекомендации для указанного `nmId` будут удалены.
     *
     * @return self
     */
