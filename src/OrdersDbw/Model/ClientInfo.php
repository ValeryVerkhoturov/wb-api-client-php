...
class ClientInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $replacement_phone Подменный номер для связи с покупателем. Пустое значение `\"\"` указывает, что номер ещё не назначен
     *
     * @return self
     */
     ...
     *
     * @param int[]|null $additional_phone_codes Дополнительные добавочные коды. Используйте, если не получилось дозвониться по добавочному коду из `phoneCode`. Пустое значение указывает, коды ещё не назначены
     *
     * @return self
     */
     ...
     * Sets phone_code
     *
     * @param int|null $phone_code Добавочный код. Используйте, чтобы связаться с покупателем по номеру из `phone`. Если код не указан, вы можете связаться с покупателем без кода
     *
     * @return self
     */
