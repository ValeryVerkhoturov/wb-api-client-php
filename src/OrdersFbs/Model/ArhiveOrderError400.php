...
class ArhiveOrderError400 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'code' => 'string',
        'detail' => 'string',
        'errors' => '\ValeryVerkhoturov\WbApiClient\OrdersFbs\Model\ArhiveOrderError400ErrorsInner[]',
        'origin' => 'string',
        'request_id' => 'string',
        'status' => 'int',
        'title' => 'string'
    ...
    */
     ...
     * Gets errors
     *
     * @return \ValeryVerkhoturov\WbApiClient\OrdersFbs\Model\ArhiveOrderError400ErrorsInner[]|null
     */
     ...
     * Sets errors
     *
     * @param \ValeryVerkhoturov\WbApiClient\OrdersFbs\Model\ArhiveOrderError400ErrorsInner[]|null $errors Информация об ошибке
     *
     * @return self
     */
