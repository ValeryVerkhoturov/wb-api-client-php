...
namespace ValeryVerkhoturov\WbApiClient\OrdersFbs\Model;
...
class Order implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'address' => '\ValeryVerkhoturov\WbApiClient\OrdersFbs\Model\OrderAddress',
        'scan_price' => 'float',
        ...
        'comment' => 'string',
        'is_zero_order' => 'bool',
        'options' => '\ValeryVerkhoturov\WbApiClient\OrdersFbs\Model\OrderOptions'
    ];
    ...
    */
     ...
     * Gets address
     *
     * @return \ValeryVerkhoturov\WbApiClient\OrdersFbs\Model\OrderAddress|null
     */
     ...
     * Sets address
     *
     * @param \ValeryVerkhoturov\WbApiClient\OrdersFbs\Model\OrderAddress|null $address address
     *
     * @return self
     */
     ...
     * Sets rid
     *
     * @param string|null $rid Уникальный ID заказа. Примечание: `rid` — это `srid` в ответах методов: - [Заявки покупателей на возврат](./customer-communication#tag/buyersReturns/operation/getV1Claims) - [Лента заказов](./analytics#tag/orderFeed/operation/postV1OrderFeed) - [Заказы](./reports#tag/mainReports/operation/getV1SupplierOrders) - [Продажи](./reports#tag/mainReports/operation/getV1SupplierSales) - [Отчет о возвратах и перемещении товаров](./reports#tag/returnsAndItemMovementReport) - [Детализации к отчётам реализации по ID отчётов](./documents-and-accounting#tag/financialReports/operation/postV1SalesReportsDetailedReportId) - [Детализации к отчётам реализации за период](./documents-and-accounting#tag/financialReports/operation/postV1SalesReportsDetailed) - [Детализации к отчётам об издержках на приём платежей по ID отчётов](./documents-and-accounting#tag/financialReports/operation/postV1AcquiringDetailedReportId) - [Детализации к отчётам об издержках на приём платежей за период](./documents-and-accounting#tag/financialReports/operation/postV1AcquiringDetailed)
     *
     * @return self
     */
     ...
     * Gets options
     *
     * @return \ValeryVerkhoturov\WbApiClient\OrdersFbs\Model\OrderOptions|null
     */
     ...
     * Sets options
     *
     * @param \ValeryVerkhoturov\WbApiClient\OrdersFbs\Model\OrderOptions|null $options options
     *
     * @return self
     */
