...
class OrderNew implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets ddate
     *
     * @param string|null $ddate Планируемая дата доставки заказа покупателю. Поле отображается для сборочных заданий со сверхгабаритными товарами `СГТ`, `cargoType: 2`
     *
     * @return self
     */
     ...
     * Sets seller_date
     *
     * @param string|null $seller_date Рекомендуемая дата доставки СГТ в сортировочный центр или на склад. Поле отображается для сборочных заданий со сверхгабаритными товарами `СГТ`, `cargoType: 2`
     *
     * @return self
     */
