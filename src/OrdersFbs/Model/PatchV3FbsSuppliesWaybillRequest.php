...
/**
 * PatchV3FbsSuppliesWaybillRequest Class Doc Comment
 *
 * @category Class
 * @package  ValeryVerkhoturov\WbApiClient\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class PatchV3FbsSuppliesWaybillRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'patchV3FbsSuppliesWaybill_request';
    ...
    protected static $openAPITypes = [
        'data' => '\ValeryVerkhoturov\WbApiClient\OrdersFbs\Model\UpdateSupplyWaybill[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \ValeryVerkhoturov\WbApiClient\OrdersFbs\Model\UpdateSupplyWaybill[]
     */
     ...
     * Sets data
     *
     * @param \ValeryVerkhoturov\WbApiClient\OrdersFbs\Model\UpdateSupplyWaybill[] $data data
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ((count($data) > 100)) {
            throw new \InvalidArgumentException('invalid value for $data when calling PatchV3FbsSuppliesWaybillRequest., number of items must be less than or equal to 100.');
        }
        if ((count($data) < 1)) {
            throw new \InvalidArgumentException('invalid length for $data when calling PatchV3FbsSuppliesWaybillRequest., number of items must be greater than or equal to 1.');
        }
