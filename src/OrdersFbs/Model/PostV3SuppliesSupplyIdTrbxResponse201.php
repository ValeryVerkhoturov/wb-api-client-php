...
/**
 * PostV3SuppliesSupplyIdTrbxResponse201 Class Doc Comment
 *
 * @category Class
 * @package  ValeryVerkhoturov\WbApiClient\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class PostV3SuppliesSupplyIdTrbxResponse201 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostV3SuppliesSupplyIdTrbxResponse201';
    ...
    */
    ...
    public function setTrbxIds($trbx_ids)
    {
        ...
        if ((count($trbx_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $trbx_ids when calling PostV3SuppliesSupplyIdTrbxResponse201., number of items must be greater than or equal to 1.');
        }
