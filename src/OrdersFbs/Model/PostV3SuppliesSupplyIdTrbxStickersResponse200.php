...
/**
 * PostV3SuppliesSupplyIdTrbxStickersResponse200 Class Doc Comment
 *
 * @category Class
 * @package  ValeryVerkhoturov\WbApiClient\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class PostV3SuppliesSupplyIdTrbxStickersResponse200 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostV3SuppliesSupplyIdTrbxStickersResponse200';
    ...
    protected static $openAPITypes = [
        'stickers' => '\ValeryVerkhoturov\WbApiClient\OrdersFbs\Model\TrbxStickers[]'
    ];
    ...
    */
     ...
     * Gets stickers
     *
     * @return \ValeryVerkhoturov\WbApiClient\OrdersFbs\Model\TrbxStickers[]|null
     */
     ...
     * Sets stickers
     *
     * @param \ValeryVerkhoturov\WbApiClient\OrdersFbs\Model\TrbxStickers[]|null $stickers stickers
     *
     * @return self
     */
    public function setStickers($stickers)
    {
        ...
        if ((count($stickers) < 1)) {
            throw new \InvalidArgumentException('invalid length for $stickers when calling PostV3SuppliesSupplyIdTrbxStickersResponse200., number of items must be greater than or equal to 1.');
        }
