...
/**
 * SupplySpotDataResponseSuppliesInnerSpot Class Doc Comment
 *
 * @category Class
 * @package  ValeryVerkhoturov\WbApiClient\OrdersFbs
 * @author   OpenAPI Generator team
 ...
 */
class SupplySpotDataResponseSuppliesInnerSpot implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SupplySpotDataResponse_supplies_inner_spot';
    ...
    */
    ...
    public function setCarrierName($carrier_name)
    {
        ...
        if ((mb_strlen($carrier_name) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $carrier_name when calling SupplySpotDataResponseSuppliesInnerSpot., must be smaller than or equal to 1000.');
        }
        if ((mb_strlen($carrier_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $carrier_name when calling SupplySpotDataResponseSuppliesInnerSpot., must be bigger than or equal to 1.');
        }
