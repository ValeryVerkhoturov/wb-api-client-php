...
/**
 * UpdatedSuppliesWaybillError Class Doc Comment
 *
 * @category Class
 * @description Ошибка обработки запроса для поставки. Возможные варианты ошибок:   - &#x60;400 IncorrectRequestBody&#x60;:     - некорректный ID поставки     - склад назначения находится не в РФ   - &#x60;404 NotFound&#x60; — поставка не найдена   - &#x60;409 SupplyAlreadyScanned&#x60; — поставка или её короба уже отсканированы в пункте отгрузки   - &#x60;409 SupplyShippingRequired&#x60; — не указан пункт отгрузки поставки   - &#x60;409 UnsuitableShippingType&#x60; — не указан способ доставки либо способ доставки не &#x60;transportCompany&#x60;   - &#x60;409 WaybillUUIDIsProcessing&#x60; — ЭТрН находится в обработке
 * @package  ValeryVerkhoturov\WbApiClient\OrdersFbs
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UpdatedSuppliesWaybillError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdatedSuppliesWaybill_error';
