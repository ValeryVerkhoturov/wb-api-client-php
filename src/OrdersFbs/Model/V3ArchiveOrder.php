...
class V3ArchiveOrder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'color_code' => 'string',
        'created_at' => 'string',
        'cross_border' => '\ValeryVerkhoturov\WbApiClient\OrdersFbs\Model\V3ArchiveOrderCrossBorder',
        'cross_border_type' => 'string',
        'id' => 'int',
        'is_zero_order' => 'bool',
        'meta_details' => '\ValeryVerkhoturov\WbApiClient\OrdersFbs\Model\V3ArchiveOrderMetaDetailsInner[]',
        'options' => '\ValeryVerkhoturov\WbApiClient\OrdersFbs\Model\V3ArchiveOrderOptions',
        'order_uid' => 'string',
        'price_info' => '\ValeryVerkhoturov\WbApiClient\OrdersFbs\Model\V3ArchiveOrderPriceInfo',
        'product' => '\ValeryVerkhoturov\WbApiClient\OrdersFbs\Model\V3ArchiveOrderProduct',
        'rid' => 'string',
        'scan_price' => 'int',
        'status' => '\ValeryVerkhoturov\WbApiClient\OrdersFbs\Model\V3ArchiveOrderStatus',
        'sticker_id' => 'int',
        'supply_id' => 'string',
        'warehouse_id' => 'int'
    ];
