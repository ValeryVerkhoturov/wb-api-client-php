...
class ModelsGoodInSupply implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets tnved
     *
     * @param string|null $tnved Код ТНВЭД.  Если `\"needKiz\":true`, а `\"tnved\":null`, нужно заполнить характеристику товара \\*\\*ТН ВЭД\\*\\* в [личном кабинете](https://seller.wildberries.ru/new-goods) или по [API](./item-management#tag/listings/operation/postV2CardsUpdate)
     *
     * @return self
     */
