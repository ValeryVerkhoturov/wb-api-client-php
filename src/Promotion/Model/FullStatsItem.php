...
class FullStatsItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'advert_id' => 'int',
        'atbs' => 'int',
        'booster_stats' => '\ValeryVerkhoturov\WbApiClient\Promotion\Model\FullStatsItemBoosterStatsInner[]',
        'canceled' => 'int',
        'clicks' => 'int',
        'cpc' => 'float',
        'cr' => 'float',
        'ctr' => 'float',
        'days' => '\ValeryVerkhoturov\WbApiClient\Promotion\Model\FullStatsItemDaysInner[]',
        'orders' => 'int',
        'shks' => 'int',
        'sum' => 'float',
        'sum_price' => 'float',
    ...
    */
     ...
     * Gets booster_stats
     *
     * @return \ValeryVerkhoturov\WbApiClient\Promotion\Model\FullStatsItemBoosterStatsInner[]|null
     */
     ...
     * Sets booster_stats
     *
     * @param \ValeryVerkhoturov\WbApiClient\Promotion\Model\FullStatsItemBoosterStatsInner[]|null $booster_stats Статистика по средней позиции товара (для кампаний с единой ставкой)
     *
     * @return self
     */
