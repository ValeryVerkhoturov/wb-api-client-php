...
/**
 * FullStatsItemDaysInnerAppsInner Class Doc Comment
 *
 * @category Class
 * @package  ValeryVerkhoturov\WbApiClient\Promotion
 * @author   OpenAPI Generator team
 ...
 */
class FullStatsItemDaysInnerAppsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FullStatsItem_days_inner_apps_inner';
    ...
    protected static $openAPITypes = [
        ...
        'cr' => 'float',
        'ctr' => 'float',
        'nms' => '\ValeryVerkhoturov\WbApiClient\Promotion\Model\FullStatsItemDaysInnerAppsInnerNmsInner[]',
        'orders' => 'int',
        'shks' => 'int',
        'sum' => 'float',
        'sum_price' => 'float',
