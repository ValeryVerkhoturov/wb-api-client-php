...
class PostV1BudgetDepositRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param int|null $cashback_percent Процент от суммы пополнения, который можно пополнить промо-бонусами. Нужно указать значение поля percent из ответа метода получения [баланса](./promotion#tag/finances/operation/getV1Balance)  Если вы указали `cashback\\_sum`, параметр `cashback\\_percent` становится обязательным
     *
     * @return self
     */
