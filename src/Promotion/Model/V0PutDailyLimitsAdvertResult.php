...
/**
 * V0PutDailyLimitsAdvertResult Class Doc Comment
 *
 * @category Class
 * @package  ValeryVerkhoturov\WbApiClient\Promotion
 * @author   OpenAPI Generator team
 ...
 */
class V0PutDailyLimitsAdvertResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V0PutDailyLimitsAdvertResult';
    ...
    protected static $setters = [
        ...
        'below_min_limit' => 'setBelowMinLimit',
    ...
    protected static $getters = [
        ...
        'below_min_limit' => 'getBelowMinLimit',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('below_min_limit', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['below_min_limit'];
    }
     ...
     * @return self
     */
    public function setBelowMinLimit($below_min_limit)
    {
        if (is_null($below_min_limit)) {
            throw new \InvalidArgumentException('non-nullable below_min_limit cannot be null');
        }
        $this->container['below_min_limit'] = $below_min_limit;
