...
/**
 * V0PutDailyLimitsRequest Class Doc Comment
 *
 * @category Class
 * @package  ValeryVerkhoturov\WbApiClient\Promotion
 * @author   OpenAPI Generator team
 ...
 */
class V0PutDailyLimitsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V0PutDailyLimitsRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['advert_ids']) > 100)) {
            $invalidProperties[] = "invalid value for 'advert_ids', number of items must be less than or equal to 100.";
        }
        ...
        if (!is_null($this->container['daily_limit']) && ($this->container['daily_limit'] < 1000)) {
            $invalidProperties[] = "invalid value for 'daily_limit', must be bigger than or equal to 1000.";
        }
     ...
     * Sets advert_ids
     *
     * @param int[] $advert_ids ID кампаний
     *
     * @return self
     */
    public function setAdvertIds($advert_ids)
    {
        ...
        if ((count($advert_ids) > 100)) {
            throw new \InvalidArgumentException('invalid value for $advert_ids when calling V0PutDailyLimitsRequest., number of items must be less than or equal to 100.');
        }
        if ((count($advert_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $advert_ids when calling V0PutDailyLimitsRequest., number of items must be greater than or equal to 1.');
        }
     ...
     * Sets enabled
     *
     * @param bool $enabled Включить лимит:   - `true` — да   - `false` — нет
     *
     * @return self
     */
    ...
    public function setDailyLimit($daily_limit)
    {
        ...
        if (($daily_limit < 1000)) {
            throw new \InvalidArgumentException('invalid value for $daily_limit when calling V0PutDailyLimitsRequest., must be bigger than or equal to 1000.');
        }
     ...
     *
     * @param bool|null $carry_over_enabled Переносить неиспользованный остаток лимита на следующий день:   - `true` — да   - `false` — нет  Параметр обязателен при `\"enabled\": true`
     *
     * @return self
     */
