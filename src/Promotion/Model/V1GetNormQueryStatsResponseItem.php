...
class V1GetNormQueryStatsResponseItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'advert_id' => 'int',
        'nm_id' => 'int',
        'daily_stats' => '\ValeryVerkhoturov\WbApiClient\Promotion\Model\V1GetNormQueryStatsResponseItemDailyStat[]'
    ];
    ...
    */
     ...
     * Gets daily_stats
     *
     * @return \ValeryVerkhoturov\WbApiClient\Promotion\Model\V1GetNormQueryStatsResponseItemDailyStat[]|null
     */
     ...
     * Sets daily_stats
     *
     * @param \ValeryVerkhoturov\WbApiClient\Promotion\Model\V1GetNormQueryStatsResponseItemDailyStat[]|null $daily_stats Статистика с детализацией по дням
     *
     * @return self
     */
