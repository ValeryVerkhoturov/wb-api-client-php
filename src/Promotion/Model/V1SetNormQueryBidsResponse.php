...
class V1SetNormQueryBidsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'success' => '\ValeryVerkhoturov\WbApiClient\Promotion\Model\V1SetNormQueryBidsSuccessResponseItem[]',
        'failed' => '\ValeryVerkhoturov\WbApiClient\Promotion\Model\NormQueryBidFailResponseItem[]'
    ];
