...
class V2BudgetResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'adverts' => '\ValeryVerkhoturov\WbApiClient\Promotion\Model\V1BudgetAdvert[]'
    ];
    ...
    */
     ...
     * Gets adverts
     *
     * @return \ValeryVerkhoturov\WbApiClient\Promotion\Model\V1BudgetAdvert[]
     */
     ...
     * Sets adverts
     *
     * @param \ValeryVerkhoturov\WbApiClient\Promotion\Model\V1BudgetAdvert[] $adverts Данные по кампаниям
     *
     * @return self
     */
