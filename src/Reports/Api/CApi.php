...
class CApi
{
     ...
     * @param  \ValeryVerkhoturov\WbApiClient\Reports\Model\ExciseReportRequest $excise_report_request excise_report_request (optional)
     ...
     * @param  string $date_from Начало отчётного периода, &#x60;ГГГГ-ММ-ДД&#x60; (required)
     * @param  string $date_to Конец отчётного периода, &#x60;ГГГГ-ММ-ДД&#x60; (required)
     * @param  \ValeryVerkhoturov\WbApiClient\Reports\Model\ExciseReportRequest $excise_report_request (optional)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postV1AnalyticsExciseReport'] to see the possible values for this operation
     *
    ...
    public function postV1AnalyticsExciseReportWithHttpInfo($date_from, $date_to, $excise_report_request = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['postV1AnalyticsExciseReport'][0])
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\ValeryVerkhoturov\WbApiClient\Reports\Model\ExciseReportResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ValeryVerkhoturov\WbApiClient\Reports\Model\ExciseReportResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ValeryVerkhoturov\WbApiClient\Reports\Model\ExciseReportResponse', []),
            ...
            $returnType = '\ValeryVerkhoturov\WbApiClient\Reports\Model\ExciseReportResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ValeryVerkhoturov\WbApiClient\Reports\Model\ExciseReportResponse',
