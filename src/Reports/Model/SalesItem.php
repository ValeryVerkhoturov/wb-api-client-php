...
class SalesItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const WAREHOUSE_TYPE_X = 'Склад продавца';
    ...
    */
     ...
     * Sets for_pay
     *
     * @param float|null $for_pay К перечислению продавцу. Синхронизация данных занимает до 24 часов, в течение этого времени в поле может отображаться значение `0`
     *
     * @return self
     */
     ...
     * Sets finished_price
     *
     * @param float|null $finished_price Фактическая цена с учётом всех скидок (к взиманию с покупателя). Синхронизация данных занимает до 24 часов, в течение этого времени в поле может отображаться значение `0`
     *
     * @return self
     */
     ...
     *
     * @param float|null $price_with_disc Цена со скидкой продавца, в том числе со скидкой WB Клуба, от которой рассчитывается сумма к перечислению продавцу `forPay`. Синхронизация данных занимает до 24 часов, в течение этого времени в поле может отображаться значение `0`
     *
     * @return self
     */
     ...
     * Sets srid
     *
     * @param string|null $srid Уникальный ID заказа. Примечание для использующих API Маркетплейс: `srid` равен `rid` в ответах методов сборочных заданий.
     *
     * @return self
     */
